        ...
        return (
                <div className="NewsTitle">
                    <ul className="header-tool__services">
                        <li>
                            <div className="header-service-shipping__Wrapper">
                                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                                    width="20px" height="20px" viewBox="0 0 1247.000000 1280.000000"
                        ...
                        <li>
                            <span className="header-tool__helpService"><Link to="/services">Need help with anything?</Link></span>
                        </li>
                    </ul>
